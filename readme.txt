...
Copyright (c) 2009 by Source Dynamics, Inc.
...
You will need the SERIAL NUMBER from the CD jacket when you install 
...
the "My Documents" folder for each logged in user that runs SI. 
